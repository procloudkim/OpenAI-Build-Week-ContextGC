...
For ContextGC 0.1.11 with the checked-in fixtures, the exact observable is:
...
add-only path was verified for `0.1.11`; do not overwrite the versioned cache by
hand.

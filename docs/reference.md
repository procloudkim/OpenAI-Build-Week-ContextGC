...
- **Scope:** ContextGC `0.1.5` as verified on 2026-07-19.
...
| --- | --- | --- |
| ContextGC | `0.1.5` | Recheck this reference and release notes |
...
- **Rollback:** operational shorthand for restoring a previously recorded
  checkpoint ID. ContextGC `0.1.5` has no public checkpoint-list command, so

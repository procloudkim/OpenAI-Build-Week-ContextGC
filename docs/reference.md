...
- **Scope:** ContextGC `0.1.13` as verified on 2026-07-23.
...
| --- | --- | --- |
| ContextGC | `0.1.13` | Recheck this reference and release notes |
...
- **Rollback:** operational shorthand for restoring a previously recorded
  checkpoint ID. ContextGC `0.1.13` has no public checkpoint-list command, so

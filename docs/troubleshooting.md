...
If metadata is absent, confirm plugin version `0.1.10`, reinstall, and start a
...
`0.1.7` or newer (`0.1.10` is the current documented release). The `0.1.7`
...
ContextGC intentionally has no recursive-delete command in release `0.1.10`.

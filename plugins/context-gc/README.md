...
ContextGC `0.1.9` is a prebuilt Codex plugin for Node.js 22.13 or newer. No
...
```text
context-gc@context-gc-local  installed, enabled  0.1.9
```
...
Preserve important checkpoint UUIDs. ContextGC `0.1.9` does not expose a public
...
[benchmark receipt](https://github.com/procloudkim/OpenAI-Build-Week-ContextGC/blob/v0.1.9/output/benchmark/benchmark-report.json). This is
...
- [English user manual](https://github.com/procloudkim/OpenAI-Build-Week-ContextGC/blob/v0.1.9/docs/user-manual.md)
- [한국어 사용자 매뉴얼](https://github.com/procloudkim/OpenAI-Build-Week-ContextGC/blob/v0.1.9/docs/user-manual.ko.md)
- [Troubleshooting](https://github.com/procloudkim/OpenAI-Build-Week-ContextGC/blob/v0.1.9/docs/troubleshooting.md)
- [Interface reference](https://github.com/procloudkim/OpenAI-Build-Week-ContextGC/blob/v0.1.9/docs/reference.md)
- [Security and privacy](https://github.com/procloudkim/OpenAI-Build-Week-ContextGC/blob/v0.1.9/docs/security-and-privacy.md)
